...
export const projectRecords = [
  {
    ...
    description:
      '해상풍력발전설비 설치에 따른 軍 작전성 검토 협의 및 절차 분석, 인근 軍 작전요소 파악, 전파영향 조사 등을 통해 풍력발전사업 추진 가능 여부를 평가. (야월/두우리/칠산, 연평, 여수, 울산 귀신고래 등)',
    category: '해상풍력 · 국방',
  },
  {
    period: '2020년 ~',
    ...
    description:
      '육상 풍력발전설비 설치에 따른 軍 작전성 검토 협의 절차와 인근 軍 작전요소, 전파영향 등을 사전에 조사하여 풍력발전사업 추진 타당성을 검토. (영월, 삼동산, 구룡, 고성 등)',
    category: '육상풍력 · 국방',
  },
  {
    period: '2019년',
