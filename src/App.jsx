        ...
        <section id="services" className="scroll-mt-24 bg-slate-50 py-20 sm:py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <SectionTitle
              ...
              description="㈜ 씨이지앤드플러스는 2012년 설립 이후 국방 C5ISR 및 공공분야 IT 산업발전을 위해 개념설계, 정보기술과 전략구상, 기술성숙도 분석 등 연구·개발 업무를 수행해 왔습니다. 또한 청정 에너지 획득을 위한 풍력발전 건설 지원의 일환으로 군 작전성 검토 및 전파영향 평가에 따른 인·허가 지원 연구를 수행하고 있습니다. 빠르게 변화하는 환경 속에서 변화의 속도와 방향을 앞서 읽고 지속적인 R&D와 소통을 통해 고객에게 신뢰를 드리는 ICT 전문 파트너를 지향합니다."
            />
